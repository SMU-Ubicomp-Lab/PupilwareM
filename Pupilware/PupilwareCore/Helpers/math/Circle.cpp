...
Circle::Circle(Point2f *V1, Point2f *V2, Point2f *V3)
{
	this->m_dRadius=-1;		// error checking 
...
float Circle::GetLengthBetween2Points( Point2f * pt1, Point2f * pt2)
{
	return sqrtf(((pt1->x - pt2->x)*(pt1->x - pt2->x))+((pt1->y - pt2->y)*(pt1->y - pt2->y)));
}

bool Circle::IsPerpendicular(Point2f *pt1, Point2f *pt2, Point2f *pt3)
...
double Circle::CalcCircle(Point2f *pt1, Point2f *pt2, Point2f *pt3)
{
	double yDelta_a= pt2->y - pt1->y;
	double xDelta_a= pt2->x - pt1->x;
	double yDelta_b= pt3->y - pt2->y;
