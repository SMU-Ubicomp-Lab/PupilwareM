...
#ifndef MDSTARBURSTFUZZY_HPP
#define MDSTARBURSTFUZZY_HPP

#include "IPupilAlgorithm.hpp"

namespace pw {

    class MDStarbustFuzzy : public IPupilAlgorithm {

    public:
        MDStarbustFuzzy( const std::string& name );
        MDStarbustFuzzy( const MDStarbustFuzzy& other)=default;
        MDStarbustFuzzy( MDStarbustFuzzy&& other)=default;
        MDStarbustFuzzy& operator=( const MDStarbustFuzzy& other)=default;
        MDStarbustFuzzy& operator=( MDStarbustFuzzy&& other)=default;
        virtual ~MDStarbustFuzzy();
